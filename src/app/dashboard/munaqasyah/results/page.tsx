...
import { listAllMunaqasyahCombinedResults } from '@/features/munaqasyah/queries/list-munaqasyah-combined-results';
import { listAllPendingAssessments } from '@/features/munaqasyah/queries/list-all-pending-assessments';
...
export default async function MunaqasyahResultsPage() {
  ...
  const [results, pendingAssessments, scoringWeights, gradeSettings, finalScoreWeights, academicSetting] =
    await Promise.all([
      listAllMunaqasyahCombinedResults(),
      listAllPendingAssessments(),
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        description="Nilai peserta yang sudah dijadwalkan dan pantau hasil Tasmi, Munaqasyah, dan nilai akhir gabungan"
      />
