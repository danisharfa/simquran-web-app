...
export function TashihScheduleCreateDialog({ schedulableRequests }: Props) {
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="max-h-[85vh] overflow-y-auto sm:max-w-2xl">
        <DialogHeader>
          ...
          <DialogDescription>Jadwalkan sesi tashih untuk permintaan yang diterima.</DialogDescription>
        </DialogHeader>
